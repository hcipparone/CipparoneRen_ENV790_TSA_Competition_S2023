...
```{r}
export(SARIMA_forecast_2011, file="./Competition copy/Output/submission_1.xlsx")

export(SNAIVE_seas_2011, file="./Competition copy/Output/submission_2.xlsx")

export(ETS_fit_2011, file="./Competition copy/Output/submission_3.xlsx")

export(ARIMA_Four_1_for_2011, file="./Competition copy/Output/submission_4.xlsx")

export(ARIMA_Four_2_for_2011, file="./Competition copy/Output/submission_5.xlsx")

export(NN_for_2011, file="./Competition copy/Output/submission_6.xlsx")
